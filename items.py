...
class Item:
    """
    An Item is a cleaned, curated datapoint of a Product with its Price,
    generates a formatted prompt suitable for fine-tuning an LLM
    """
    ...
    def make_prompt(self, text):
        ...
        self.prompt += f"{self.PREFIX}{str(round(self.price))}."
